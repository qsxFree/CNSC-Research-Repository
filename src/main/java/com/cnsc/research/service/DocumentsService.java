...
public class DocumentsService {
    ...
    @Autowired
    public DocumentsService(DocumentsRepository repository, AzureStorageUtility storageUtility, Logger logger) {
    ...
    public ResponseEntity uploadFile(MultipartFile file) {
        ...
        try {
            storageUtility.inContainer(AzureStorageUtility.DOCUMENT_CONTAINER)
